...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showLat = (TextView)findViewById(R.id.latTv);
        showLong =(TextView)findViewById(R.id.lngTv);
...
//Place current location marker
        showLat.setText(String.valueOf(location.getLatitude()));
        showLong.setText(String.valueOf(location.getLongitude()));
