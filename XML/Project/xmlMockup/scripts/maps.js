...
(function($){
    ...
    function mainMap() {
      ...
      // Infobox Output
      function locationData(locationURL,locationImg,locationTitle,contactName, locationAddress, locationRating, locationRatingCounter) {
          return(''+
      ...
      var locations = [
        ...
        [ locationData('listings-single-page.html','images/listing-item-01.jpg',"กลุ่มทอผ้าหมี่ขิตบ้านนาข่า","อนุสรณ์ไง จะใครละ?",' 301 หมู่1 บ้านนาข่า ต.นาข่า อ.เมือง จ.อุดรธานี 5555', '4.5', '12'), 16.4765128,102.8223782, 8, '<i class="im im-icon-Chef-Hat"></i>'],
      ...
      var map = new google.maps.Map(document.getElementById('map'), {
        ...
        center: new google.maps.LatLng(16.6765128,102.8223782),
